...
export default function SettingsPage() {
  ...
  if (!settings) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-500">Garage settings not found</p>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Garage Settings</h1>
                <p className="text-gray-600">Manage your garage information and preferences</p>
              </div>
            </div>
            <Button
              onClick={handleSave}
